...
void
Neuron::SetValue (double new_value)
{
  this->value = new_value;
}
double
Neuron::GetValue () const
{
  return this->value;
}

void
Neuron::FeedForwardFrom (const Layer &previous_layer)
{
  this->value = 0.0;
...
void
Neuron::UpdateOutputLayerGradient (double target_value)
{
...
void
Neuron::UpdateHiddenLayerGradient (const Layer &next_layer)
{
...
void
Neuron::UpdateLayerWeight (Layer &prev_layer)
{
...
double
Neuron::TransferFunction (double value)
{
...
double
Neuron::TransferFunctionDerv (double value)
{
