...
void
NeuralNetwork::ForwardPropagate (const std::vector<double> &features)
{
...
void
NeuralNetwork::BackPropagate (const std::vector<double> &labled_examples)
{
...
double
NeuralNetwork::GetRMS () const
{
  return this->RMS;
}

void
NeuralNetwork::SaveNeuralNetwork (const std::string &file_name) const
{
...
bool
NeuralNetwork::LoadNeuralNetwork (const std::string &file_name)
{
